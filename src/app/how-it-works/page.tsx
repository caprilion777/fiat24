...
const steps = [
  {
    ...
    content: (
      <div style={{ marginTop: 8, marginBottom: 8, marginLeft: 16, fontSize: 16 }}>
        <div>Перейдите в раздел «Оставить заявку», укажите сумму и валюту для получения (RUB, EUR, USD), способ получения (наличные или безналичные средства), страну и город получения, контакт в Telegram, и отправьте заявку.</div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div style={{ marginTop: 8, marginBottom: 8, marginLeft: 16, fontSize: 16 }}>
        <div>Оператор свяжется с вами через Telegram и уточнит условия сделки — сумму, валюту, способ получения, курс, время и место (для наличных). Для бронирования встречи переведите 5 USDT на официальный кошелёк Fiat24; при обмене на безналичные эта сумма будет добавлена к сумме криптовалюты.</div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div style={{ marginTop: 8, marginBottom: 8, marginLeft: 16, fontSize: 16 }}>
        <div><b>Наличные средства:</b> на встрече в офисе проверяется сумма наличных, вы переводите криптовалюту и получаете деньги.<br /><b>Безналичные средства:</b> криптовалюта переводится на официальный кошелёк Fiat24 по согласованному курсу, а эквивалентные средства перечисляются на банковский счёт или иной согласованный реквизит.</div>
      </div>
    ),
  },
];
    ...
    <div style={{ background: bg, color: text, minHeight: "100vh", padding: 0 }}>
      ...
      >
        <h1
          ...
          style={{ color: text }}
        >
          {"Обмен криптовалюты в деньги — наличные или безналичные: инструкция для клиентов"}
        </h1>
