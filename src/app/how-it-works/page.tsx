...
const steps = [
  {
    ...
    content: (
      <div style={{ marginTop: 8, marginBottom: 8, marginLeft: 16, fontSize: 16 }}>
        <div>Перейдите в раздел «Оставить заявку», заполните форму (укажите сумму в желаемой валюте для обмена на криптовалюту, страну и город получения, контакт в Telegram) и отправьте её.</div>
      </div>
    ),
  },
  {
