...
const steps = [
  {
    ...
    content: (
      <div style={{ marginTop: 8, marginBottom: 8, marginLeft: 16, fontSize: 16 }}>
        <div>Перейдите в раздел «Оставить заявку», укажите сумму в нужной валюте для получения при обмене криптовалюты на наличные, страну и город получения, а также контакт в Telegram, затем отправьте заявку.</div>
      </div>
    ),
  },
  {
